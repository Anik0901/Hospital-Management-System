...
public class AboutUs
{
	...
	AboutUs()
	{
        ...
        JLabel heading = new JLabel("GUNUPUR HOSPITAL");
        ...
        JLabel heading1 = new JLabel("GUNUPUR HOSPITAL");
        ...
        String text3 = "At  GUNUPUR HOSPITAL staff, faculty, students, volunteers and supporters are dedicated to improving the lives of people and families affected by psychiatric illness. As the largest psychiatric affiliate of Sub-Divisional hospital Rayagada, GUNUPUR HOSPITAL has been meeting the needs of individuals and families with psychiatric illness since our founding in 1996. We are here to help you.";
